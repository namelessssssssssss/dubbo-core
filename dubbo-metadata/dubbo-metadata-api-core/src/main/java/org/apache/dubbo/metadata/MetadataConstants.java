...
public interface MetadataConstants {
    ...
    Class JAVAX_SERVLET_REQ_CLASS = ClassUtils.resolveClass(JAVAX_SERVLET_REQ_CLASS_NAME, ClassUtils.getClassLoader());
    String JAVAX_SERVLET_RES_CLASS_NAME = "javax.servlet.ServletResponse";
    Class JAVAX_SERVLET_RES_CLASS = ClassUtils.resolveClass(JAVAX_SERVLET_RES_CLASS_NAME, ClassUtils.getClassLoader());
    String JAKARTA_SERVLET_REQ_CLASS_NAME = "jakarta.servlet.ServletRequest";
    Class JAKARTA_SERVLET_REQ_CLASS = ClassUtils.resolveClass(JAKARTA_SERVLET_REQ_CLASS_NAME, ClassUtils.getClassLoader());
    String JAKARTA_SERVLET_RES_CLASS_NAME = "jakarta.servlet.ServletResponse";
    Class JAKARTA_SERVLET_RES_CLASS = ClassUtils.resolveClass(JAKARTA_SERVLET_RES_CLASS_NAME, ClassUtils.getClassLoader());
