            ...
            if (ConfigUtils.isNotEmpty(stub)) {
                ...
                try {
                    ...
                    try {
                        ...
                        if (url.getParameter(CommonConstants.STUB_EVENT_KEY, DEFAULT_STUB_EVENT)) {
                            ...
                            try {
                                ...
                                LOGGER.error(LoggerCodeConstants.PROXY_FAILED_EXPORT_SERVICE, "", "", "export a stub service error.", e);
                            }
                        }
                    ...
                    LOGGER.error(LoggerCodeConstants.PROXY_FAILED_EXPORT_SERVICE, "", "", "Failed to create stub implementation class " + stub + " in consumer " + NetUtils.getLocalHost() + " use dubbo version " + Version.getVersion() + ", cause: " + t.getMessage(), t);
                    // ignore
                }
            }
        }
