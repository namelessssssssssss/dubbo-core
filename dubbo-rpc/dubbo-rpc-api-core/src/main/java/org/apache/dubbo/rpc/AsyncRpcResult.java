...
public class AsyncRpcResult implements Result {
    ...
    public AsyncRpcResult(CompletableFuture<AppResponse> future, Invocation invocation) {
        ...
        if ((rpcInvocation.get(CommonConstants.PROVIDER_ASYNC_KEY) != null || InvokeMode.SYNC != rpcInvocation.getInvokeMode()) && !future.isDone()) {
            async = true;
    ...
    public void setValue(Object value) {
        try {
            ...
            logger.error(LoggerCodeConstants.PROXY_ERROR_ASYNC_RESPONSE, "", "", "Got exception when trying to fetch the underlying result from AsyncRpcResult.");
