...
public abstract class AbstractInvoker<T> implements Invoker<T> {
    ...
    public AbstractInvoker(Class<T> type, URL url, Map<String, Object> attachment) {
        ...
        this.version = url.getVersion(CommonConstants.DEFAULT_VERSION);
    ...
    public Result invoke(Invocation inv) throws RpcException {
        ...
        if (isDestroyed()) {
            logger.warn(LoggerCodeConstants.PROTOCOL_FAILED_REQUEST, "", "", "Invoker for service " + this + " on consumer " + NetUtils.getLocalHost() + " is destroyed, " + ", dubbo version is " + Version.getVersion() + ", this invoker should not be used any longer");
        }
    ...
    private void waitForResultIfSync(AsyncRpcResult asyncResult, RpcInvocation invocation) {
        ...
        try {
             ...
             */
            Object timeoutKey = invocation.getObjectAttachmentWithoutConvert(CommonConstants.TIMEOUT_KEY);
