...
public class RpcInvocation implements Invocation, Serializable {
    ...
    public RpcInvocation(Invocation invocation, Invoker<?> invoker) {
        ...
        if (invoker != null) {
            ...
            if (url.hasParameter(CommonConstants.INTERFACE_KEY)) {
                setAttachment(CommonConstants.INTERFACE_KEY, url.getParameter(CommonConstants.INTERFACE_KEY));
            }
            if (url.hasParameter(CommonConstants.GROUP_KEY)) {
                setAttachment(CommonConstants.GROUP_KEY, url.getGroup());
            }
            if (url.hasParameter(CommonConstants.VERSION_KEY)) {
                setAttachment(CommonConstants.VERSION_KEY, url.getVersion("0.0.0"));
            }
            ...
            if (url.hasParameter(CommonConstants.APPLICATION_KEY)) {
                setAttachment(CommonConstants.APPLICATION_KEY, url.getApplication());
            }
        }
    }
