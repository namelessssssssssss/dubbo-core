...
public class GenericFilter implements Filter, Filter.Listener, ScopeModelAware {
    ...
    public Result invoke(Invoker<?> invoker, Invocation inv) throws RpcException {
        if ((inv.getMethodName().equals(CommonConstants.$INVOKE) || inv.getMethodName().equals(CommonConstants.$INVOKE_ASYNC))
            ...
            try {
                ...
                if (StringUtils.isEmpty(generic)
                    ...
                    if (!configuration.getBoolean(CommonConstants.ENABLE_NATIVE_JAVA_GENERIC_SERIALIZE, false)) {
                        ...
                        logger.error(LoggerCodeConstants.CONFIG_FILTER_VALIDATION_EXCEPTION, "", "", notice);
                        ...
                        if (byte[].class == args[i].getClass()) {
                            ...
                            throw new RpcException(
                                "Generic serialization [" +
                                    CommonConstants.GENERIC_SERIALIZATION_NATIVE_JAVA +
                    ...
                    for (int i = 0; i < args.length; i++) {
                        if (args[i] instanceof JavaBeanDescriptor) {
                            ...
                            throw new RpcException(
                                "Generic serialization [" +
                                    CommonConstants.GENERIC_SERIALIZATION_BEAN +
                                    "] only support message type " +
                    ...
                    if (args.length == 1 && args[0] instanceof String) {
                        try (UnsafeByteArrayInputStream is =
                            ...
                            args[0] = applicationModel.getExtensionLoader(Serialization.class)
                                .getExtension(CommonConstants.GENERIC_SERIALIZATION_PROTOBUF)
                        ...
                        throw new RpcException(
                            "Generic serialization [" +
                                CommonConstants.GENERIC_SERIALIZATION_PROTOBUF +
        ...
        if ((inv.getMethodName().equals(CommonConstants.$INVOKE) || inv.getMethodName().equals(CommonConstants.$INVOKE_ASYNC))
            ...
            if (ProtocolUtils.isJavaGenericSerialization(generic)) {
                try {
                    ...
                    applicationModel.getExtensionLoader(Serialization.class).getExtension(CommonConstants.GENERIC_SERIALIZATION_NATIVE_JAVA)
