...
public class RegistryProtocol implements Protocol, ScopeModelAware {
    public static final String[] DEFAULT_REGISTER_PROVIDER_KEYS = {
        ...
        GROUP_KEY, LOADBALANCE_KEY, MOCK_KEY, PATH_KEY, TIMEOUT_KEY, TOKEN_KEY, VERSION_KEY, Constants.WARMUP_KEY,
        Constants.WEIGHT_KEY, DUBBO_VERSION_KEY, RELEASE_KEY, SIDE_KEY, IPV6_KEY
    };
    ...
    private URL getProviderUrl(final Invoker<?> originInvoker) {
        Object providerURL = originInvoker.getUrl().getAttribute(Constants.EXPORT_KEY);
    ...
    public <T> Invoker<T> refer(Class<T> type, URL url) throws RpcException {
        ...
        // group="a,b" or group="*"
        Map<String, String> qs = (Map<String, String>) url.getAttribute(Constants.REFER_KEY);
    ...
    protected <T> Invoker<T> doRefer(Cluster cluster, Registry registry, Class<T> type, URL url, Map<String, String> parameters) {
        ...
        consumerAttribute.remove(Constants.REFER_KEY);
        ...
        url = url.putAttribute(Constants.CONSUMER_URL_KEY, consumerUrl);
