...
public class MigrationRule {
    ...
    private String getDefaultStep(URL consumerURL, String defaultStep) {
        String globalDefaultStep = ConfigurationUtils.getCachedDynamicProperty(consumerURL.getScopeModel(), MigrationRuleHandler.DUBBO_SERVICEDISCOVERY_MIGRATION, null);
